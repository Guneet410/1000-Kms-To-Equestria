...
function setup() {
  ...
  ground = createSprite(width/2,height-10,width + 200,20)
...
function spikeSpawn(){
  spike  = createSprite(width+10,height/2 +250,20,10);
  spike.velocityX = -8 ;
...
function stoneSpawn(){
  stones = createSprite(width+10,height/2 +250,20,10);
...
function arrows(){
  arrow = createSprite(width+10,random(height/2 +150,height/2 +200) ,20,10);
  arrow.velocityX = -6
  ...
  function dragon(){
    fireDragon = createSprite(width+10,random(height/2-150,height/2-90),30,70);
  ...
  function spawnReward(){
    gem = createSprite(width+10,random(height/2+250,height/2+100) ,20,10);
    gem.velocityX = -6 
  ...
  function birds(){
    bird = createSprite(width+10, 150,10,10);
